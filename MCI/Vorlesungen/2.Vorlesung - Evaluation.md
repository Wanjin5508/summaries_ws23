...
-  wenn Proband aufh ̈ort, Fragen stellen (z.B. Was denken Sie gerade? Was denken Sie was passieren wird?)
- kann mit anderen Interessen kollidieren (Doppelbelastung)

### Grounded Theory
- Theoriebildung durch qualitative Analyse verbaler A ̈ußerungen zur Bildung von Kategorien
...
1. **Pair-wise** comparisons of *factors*
	...
	-->确定每个Demand的Weight, - Paare bilden(z.B.PD/MD)und wichtigeres auswählen(zählen und dadurch Gewichtung)
